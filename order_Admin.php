    ...
    <div class="container-fluid p-0">
            ...
            <div class="d-flex justify-content-between sub-container">
                ...
                <div class="right-section">
                    <div style="margin-right: 8px;">
                        <img src="<?= $rowUser['ImageUrl'] ?>" class="rounded-circle"
                            style="width: 35px; height: 35px; object-fit:cover;">
                    </div>
                    <div class="fw-bold"
                        style="font-size: 25px; margin-right: 10px; display: flex; align-items: center;">
        ...
        <div class="container" style="margin-top: 50px; position: relative; top: 30px;">
            <div class="row bg-body rounded-top p-3">
                <div class="col fw-bold fs-4">ประวัติรายการสั่งซื้อ</div>
            </div>
            ...
            ?>
            <div class="row bg-body d-flex justify-content-end p-3 rounded-bottom">
                <div class="col-10 d-flex justify-content-end fw-bold">ยอดขายรวมทั้งหมด: </div>
