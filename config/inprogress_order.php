                ...
                <div class="row bg-body rounded-top p-3">
                    ...
                    <div class="col">
                        <form action="orderlist.php" method="post">
                            <button type="submit" name="inprogress-order" class="btn col-12 bg-danger p-3 rounded-3 text-light">
                    ...
                    <div class="col">
                        <form action="orderlist.php" method="post">
                            <button type="submit" name="history-order" class="btn col-12 p-3 rounded-3" style="border: 1px solid rgb(220, 53, 69); color:rgb(220, 53, 69);">
                                คำสั่งซื้อก่อนหน้า
                            </button>
                        </form>
                    </div>
        ...
        <?php } else { ?>
            <div class="container" style="margin-top: 50px; position: relative; top: 30px;">
                ...
                <div class="row bg-body d-flex justify-content-center rounded-bottom">
                    ...
                    <div class="row mt-2">
                        <h4 class="d-flex justify-content-center">คุณยังไม่มีการสั่งซื้อใดๆ!</h4>
                    </div>
