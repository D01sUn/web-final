            ...
            <div class="row bg-body rounded-top pt-5 ps-5 pe-5 pb-3">
                ...
                <div class="col">
                    <form action="checkoutform.php" method="post">
                        <button type="submit" name="default-address" class="btn col-12 p-3 rounded-3" style="border: 1px solid rgb(220, 53, 69); color:rgb(220, 53, 69);">
                            ที่อยู่ปัจจุบัน
                        </button>
                    </form>
                </div>
                <div class="col">
                    <form action="checkoutform.php" method="post">
                        <button type="submit" name="another-address" class="btn col-12 bg-danger p-3 rounded-3 text-light">
                            ที่อยู่อื่น
                        </button>
                    </form>
                </div>
                ...
                <div class="row bg-body pt-5 ps-5 pe-5">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-floating mt-3 mb-3">
                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter your phonenumber" required>
